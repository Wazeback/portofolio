...
<body class="w-[100vw] h-[100vh] justify-center items-center flex bg-indigo-500">
    <div class="flex w-[92%] h-[92%] bg-white rounded-[4rem]">
        <div class="w-1/6 flex justify-center items-center flex-col pl-6">
            <button class="text-2xl bg-blue-500 hover:bg-blue-400 text-white font-bold text-lg py-4 px-8 border-b-8 border-blue-700 hover:border-blue-500 rounded w-46 h-24">
                Contact me
            </button>
            <div class="pt-24">
        ...
        <div class="">
            <img src="magicpattern-blob-1646724009546.png"> 
        </div>
    <div>
</body>
</html>